 ...
 *   - J-type: Sign-extended 20-bit immediate (bits [31], [19:12], [20],
 * [30:21])
 *   - R-type: 5-bit shift amount (bits [24:20]) for shift instructions
 *
 * Input:
 *   - ir[31:7]: Instruction bits 31-7 (opcode, funct3, rs1, funct7, rd, shamt,
 * imm)
  ...
  always_comb begin
    ...
    case (instr_type)
      ...
      INSTR_R: begin
        ...
        // Used by: SLLI, SRLI, SRAI (when funct3 = 001/101/101 and
        // arithmetic=1)
        imm = imm_r;
      end
      default: begin
