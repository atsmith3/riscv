...
module byte_lane
    #(parameter WIDTH = 32)
    (
        // Load path: mem_data_in -> load_data_out (with extraction and
        // extension)
        input logic [WIDTH - 1 : 0] mem_data_in,
        input mem_size_t load_size,
        input logic load_unsigned,
        input logic [1 : 0] addr_low,
        // Address[1:0] for byte lane selection
  ...
  always_comb begin
    case (store_size)
      MEM_SIZE_BYTE: begin
        ...
        case (addr_low)
          ...
          2'b11:
            byte_enable = 4'b1000;
          default:
            byte_enable = 4'b0001; // Should not happen
        endcase
      end
      ...
      MEM_SIZE_HALF: begin
        ...
        case (addr_low[1])
          1'b0:
            byte_enable = 4'b0011; // Lower halfword
          1'b1:
            byte_enable = 4'b1100; // Upper halfword
          default:
            byte_enable = 4'b0011; // Should not happen
        endcase
      end
