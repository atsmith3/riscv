...
module emu_top
    ...
    (input logic SYSTEM_R_CLK_P,
     // 200 MHz diff clock, Bank 46 (1.8 V)
     input logic SYSTEM_R_CLK_N,
     input logic CPU_RESET_B,
     // Active-low reset button, Bank 66 (3.3 V)
     input logic GPIO_SW_C,
     // Center pushbutton, active-high, Bank 45
     output logic LED0_GREEN,
     // Pass indicator
  ...
  BUFG u_bufg_fb(.I(clk_fb_out),
                 .O(clk_fb));
  BUFG u_bufg_clk(.I(clk_mmcm),
                  .O(clk));
